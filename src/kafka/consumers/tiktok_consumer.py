...
class TiktokDataConsumer:
    """Consumer Kafka pour traiter les données Tiktok"""
    ...
    async def initialize(self):
        ...
        try:
            ...
            self.consumer = KafkaConsumer(
                self.kafka_config.get('topic', 'tiktok-data'), # Use get with default
                ...
                group_id=self.kafka_config.get('group_id', 'tiktok-data-consumer'), # Use get
    ...
    async def run(self):
        ...
        logger.info("Démarrage du consumer Tiktok Data...")
...
async def main():
    ...
    kafka_config = {
        ...
        'group_id': 'tiktok-data-consumer-group',
        'topic': 'tiktok-data',
    ...
    consumer = TiktokDataConsumer(kafka_config, mongodb_config, google_api_key)
