...
os.environ["GOOGLE_API_KEY"] = "AIzaSyBQGI-eMk3iAuCkNvJOfiIU8hhZ40KxoNg"
...
class FacebookCommentAnalyzer:
    ...
    def setup_analyzers(self):
        ...
        # 2. Classificateur général (même structure que pour les posts)
    ...
    def _create_general_classifier(self):
        """Crée le classificateur général pour déterminer la catégorie de base du commentaire"""
        ...
        Tu es un expert en analyse de contenu pour Orange Maroc. Analyse ce commentaire Facebook et classe-le dans l'une des catégories suivantes:
    ...
    async def analyze_comment(self, comment_text: str, post_text: str, post_analysis: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # 2. Classification générale (comme pour les posts)
        ...
        result = {
            # Structure identique au résultat de l'analyse des posts
        ...
        # Si le commentaire concerne un produit/offre
        if general_result["content_topic"] == "produit_offre":
            # Si le post original parlait déjà d'un produit spécifique, on peut utiliser cette information
            # pour améliorer la classification du commentaire
        ...
        # Si le commentaire concerne une panne/problème
        elif general_result["content_topic"] == "outage":
            # Si le post original parlait déjà d'une panne spécifique, on peut utiliser cette information
        ...
        # Si le commentaire concerne une initiative/événement
        elif general_result["content_topic"] == "initiative_evenement":
            # Si le post original parlait déjà d'une initiative spécifique, on peut utiliser cette information
        ...
        # Si le commentaire concerne un autre sujet
        elif general_result["content_topic"] == "other_topic":
            # Si le post original parlait déjà d'un sujet commun spécifique, on peut utiliser cette information
        ...
        # Ajuster le niveau de confiance global
        result["confidence"] = min(
            result["confidence"], 
            relevance_result["confidence"], 
            emotion_sentiment_result["confidence"]
        )
