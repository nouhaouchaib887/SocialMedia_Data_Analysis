...
class TiktokProducer:
    ...
    def __init__(self, 
                 ...
                 days_back: int = 15,
                 backup_dir: str = "tiktok_data_backup"):
        """
        ...
        enriched_post = {
            **post,
            ...
            'collection_metadata': {
                ...
                'collector_page': self.collector.profile_name,
                'collection_params': {
    ...
    def collect_and_publish(self) -> Tuple[Dict, List[str]]:
        ...
        try:
            ...
            if collected_posts_data:
                ...
                backup_file = self._save_backup_file(enriched_backup_data, "Tiktok_posts_with_comments")
