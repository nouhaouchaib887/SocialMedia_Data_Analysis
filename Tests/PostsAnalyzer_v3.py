...
class OrangePostAnalyzer:
    def __init__(self, google_api_key: str, config_file: str = "config/themes/orange_themes.json", intents_file: str = "config/themes/posts_intents.json", prompts_file: str = "config/prompts/prompts.yaml"):
        """
        ...
        # Appel de la méthode pour charger les prompts et les stocker dans l'attribut self.prompts
    ...
    def _create_offre_category_classifier(self):
        ...
        prompt_template_string = self.prompts['offre_category']
        category_prompt = ChatPromptTemplate.from_template(prompt_template_string)
    ...
    def _create_offre_subcategory_classifier(self):
        ...
        prompt_template_string = self.prompts['offre_subcategory']
        subcategory_prompt = ChatPromptTemplate.from_template(prompt_template_string)
    ...
    def _create_offre_product_classifier(self):
        ...
        prompt_template_string = self.prompts['offre_product']
        product_prompt = ChatPromptTemplate.from_template(prompt_template_string)
    ...
    def _create_initiative_classifier(self):
        ...
        prompt_template_string = self.prompts['initiative']
        initiative_prompt = ChatPromptTemplate.from_template(prompt_template_string)
    ...
    def _create_initiative_event_classifier(self):
        ...
        prompt_template_string = self.prompts['initiative_event']
        event_prompt = ChatPromptTemplate.from_template(prompt_template_string)
    ...
    def _create_communication_topic_classifier(self):
        ...
        prompt_template_string = self.prompts['communication_topic']
        topic_prompt = ChatPromptTemplate.from_template(prompt_template_string)
    ...
    def _create_communication_subtopic_classifier(self):
        ...
        prompt_template_string = self.prompts['communication_subtopic']
        subtopic_prompt = ChatPromptTemplate.from_template(prompt_template_string)
...
async def main():
    ...
    # J'ai remis une clé factice pour des raisons de sécurité. Utilisez la vôtre.
    ...
    try:
        ...
        analyzer = OrangePostAnalyzer(
            ...
            prompts_file="config/prompts/prompts.yaml"
        )
