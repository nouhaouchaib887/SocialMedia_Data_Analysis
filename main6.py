...
st.set_page_config(
    page_title="Orange Maroc SocialPulse",
    page_icon="📊",
    layout="wide",
...
# En-tête principal
st.markdown('<div class="main-header">Orange Maroc SocialPulse</div>', unsafe_allow_html=True)
...
st.markdown('<h3 class="comparison-header">Comparaison avec:</h3>', unsafe_allow_html=True)
col1, col2 = st.columns(2)
with col1:
    compare_inwi = st.button("Inwi", type="primary" if "Inwi" else "secondary")
with col2:
    compare_maroc = st.button("Maroc Telecom", type="primary" if "Maroc Telecom" else "secondary")
...
with col2:
    ...
    for brand in brands_to_compare:
        ...
        <div style="margin-bottom: 20px;">
            ...
            <div style="display: flex; width: 100%; height: 25px; background-color: #f0f0f0; border-radius: 5px; overflow: hidden;">
                <div style="width: {stats['positive']}%; background-color: #FF6600; height: 100%;"></div>
                <div style="width: {stats['neutre']}%; background-color: #E0E0E0; height: 100%;"></div>
                <div style="width: {stats['negative']}%; background-color: #FF3B30; height: 100%;"></div>
            </div>
    ...
    <div style="display: flex; margin-top: 20px;">
        ...
        <div style="display: flex; align-items: center; margin-right: 20px;">
            <div style="width: 15px; height: 15px; background-color: #E0E0E0; margin-right: 5px;"></div>
            <div>Neutre</div>
        </div>
        <div style="display: flex; align-items: center;">
            <div style="width: 15px; height: 15px; background-color: #FF3B30; margin-right: 5px;"></div>
            <div>Négatif</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
